        ...
        <div class="mt-5 flex flex-col gap-5">
            ...
            <table class="text-sm w-full">
                <thead class="bg-gray-100 border border-gray-300">
                    ...
                    <th class="font-normal p-3 text-center">Jumlah Anggota Keluarga</th>
                ...
                <tbody id="result">
                    @foreach ($family_cards as $family_card)
                        <tr
                            ...
                            <td class="font-normal p-2 text-center font-semibold">{{ count($family_card->members) }} Orang</td>
                            <td class="font-normal p-2 text-right font-medium">
                                <div class="flex items-center justify-end gap-1">
                                    ...
                                    <button class="p-2 border border-gray-200 rounded-md bg-white hover:bg-gray-200"
                                        onclick="showDeletePopup('{{ $family_card['id'] }}', this)">
                                        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4">
                                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                            <g id="SVGRepo_iconCarrier">
                        ...
                        if (data.length === 0) {
                            ...
                            data.forEach(member => {
                                html += `
                                    ...
                                    <td class="font-normal p-2 text-left font-medium">${member["name"]}</td>
                                    <td class="font-normal p-2 text-left font-medium">${member["phone"]}</td>
                                    ...
                                    <td class="font-normal p-2 text-right font-medium">
                                        <div class="flex items-center justify-end gap-1">
                                            ...
                                            <button class="p-2 border border-gray-200 rounded-md bg-white hover:bg-gray-200"
                                                onclick="showDeletePopup('${member['id']}', this)">
                                                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4">
                                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                                    <g id="SVGRepo_iconCarrier">
