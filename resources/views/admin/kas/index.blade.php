                ...
                <tbody id="result">
                    @foreach ($contributions as $contribution)
                                <tr class="border-b border-gray-200 transition-all ease-in-out">
                                    <td class="font-normal p-2 text-left font-semibold">{{ $contribution->member_id }}</td>
                                    <td class="font-normal p-2 text-left font-semibold">{{ $contribution->member->name }}</td>
