...
@section('content')
    <div class="mb-6">
        <h1 class="text-2xl font-bold">{{ isset($contribution) ? "Edit" : "Generate" }} Donasi Duka</h1>
        ...
        <div class="mt-5">
            ...
            @enderror
                <form action="{{ route("admin_duka_contrib_update")}}" method="post" id="form_update">
                    @csrf
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <div>
                            ...
                            <input type="text" id="member_id" name="member_id"
                                value="{{ old('member_id') ?? $contribution->family_card->id . " - " . $contribution->family_card->head->name }}"
